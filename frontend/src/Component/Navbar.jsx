    ...
    return (
        <nav className="max-w-[1920px] mx-auto px-6 lg:px-20 py-6 flex justify-between items-center bg-white sticky top-0 z-50">
            ...
            <div className="hidden lg:flex items-center gap-8 text-[16px] font-bold tracking-widest">
                <a href="#" className="hover:text-red-700">WHO WE SERVE</a>
                <a href="#" className="hover:text-red-700">SOLUTIONS</a>
                <a href="#" className="hover:text-red-700">RESOURCES</a>
                ...
                <div className="flex items-center gap-5 ml-3.5 border-l pl-7">
                    <Search size={18} className="cursor-pointer hover:text-red-700" />
                    <div className="flex items-center gap-1 cursor-pointer  hover:text-red-700">IND <ChevronDown size={16} /></div>
                    <div className="flex items-center gap-1 cursor-pointer  hover:text-red-700">ENGLISH <ChevronDown size={16} /></div>
                </div>
            </div>
        </nav>
    )
