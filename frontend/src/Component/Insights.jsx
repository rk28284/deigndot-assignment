      ...
      <section className="max-w-[1920px] mx-auto px-6 lg:px-20 py-24 grid lg:grid-cols-2 gap-20">
        <div className="flex gap-10">
          ...
          <div className="space-y-8">
            <div className="border-b-2 border-blue-600 pb-4">
              ...
              <p className="text-[12px] text-blue-600/70 mt-1 italic">Pre-market entry means trading securities before regular market hours...</p>
            </div>
            {items.map((data, index) => (
              <div key={index} className="border-b border-slate-200 pb-4 opacity-60 hover:opacity-100 cursor-pointer">
        ...
        <div className="flex gap-4 h-[500px]">
          ...
          <div className="flex-[2] relative rounded-3xl overflow-hidden group">
            ...
            <div className="absolute bottom-6 left-6 text-white"><h5 className="font-bold text-lg">Pre-Market</h5><p className="text-[10px] opacity-80">Evaluating Supply Chain Readiness</p></div>
          </div>
          <div className="flex-1 relative rounded-3xl overflow-hidden group">
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 -rotate-90 text-white font-bold whitespace-nowrap">OPERATIONS</div>
          </div>
          <div className="flex-1 relative rounded-3xl overflow-hidden group">
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 -rotate-90 text-white font-bold whitespace-nowrap">GROWTH & EXPANSION</div>
          </div>
        </div>
      </section>
  )
